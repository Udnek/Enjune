...
global using Entity = ushort; // (n=16) n-bits Entity ID -> 2^n entities are allowed to exist
global using ComponentType = byte; // (n=8) n-bits type ID -> 2^n components are allowed to exist
